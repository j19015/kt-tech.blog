    ...
    return (
        <div className="col-span-12 md:col-span-4 m-1 rounded-lg bg-gray-900 p-6 shadow-md text-gray-200">
            ...
            <div className="mb-10">
                ...
                <div className="flex flex-wrap gap-2">
                    {categoryList.map((category) => (
                        <Link key={category.id} href={`/categories/${category.id}/page/1`} className="text-indigo-500 px-0.5 py-1">
            ...
            <div className="mb-10">
                ...
                <div className="flex flex-wrap gap-2">
                    {tagList.map((tag) => (
                        <span key={tag.id} className="inline-block text-white px-0.5 py-1 rounded-full hover:text-indigo-500 text-sm mr-2 mb-2">
                ...
                <ul>
                    {archives.map((archive) => (
                        <li key={archive} className="mb-2">
                            <Link href={`/archives/${archive}`} className="text-whit hover:text-indigo-500 flex items-center">
