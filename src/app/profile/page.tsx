    ...
    <div className='grid grid-cols-1 lg:grid-cols-3 gap-4'>
      <div className='lg:col-span-2 lg:p-4'>
        <div className='rounded-lg introduction p-2 pt-6 pb-6 content'>
          ...
          <p className=' mt-2 pl-3'>
            Webアプリケーションエンジニアとして、Webアプリケーションの開発に携わっています。
            <br />
            業務ではバックエンド、インフラをメインに担当しています。
            <br />
          ...
          <ul className='list-disc mt-6 pl-6 ml-5'>
            ...
            <li className='mb-3'>
              <strong>AWS</strong> : Lamda、APIGateway、CDK、CloudWatch、EC2、S3、Secrets
              Manager、MediaLive、Route53
            </li>
            <li className='mb-3'>
              <strong>Tool</strong> : Git、bitBacket、Jira、Confluence
            </li>
          </ul>
          <h3 className='mt-10'>個人開発でのみ経験あり</h3>
          <ul className='list-disc mt-6 pl-6 ml-5'>
            <li className='mb-3'>
              <strong>Language</strong> : Ruby、PHP、C、C++、Java
            </li>
            <li className='mb-3'>
              <strong>FW</strong> : Express、Rails、Next.js
            </li>
            <li className='mb-3'>
              <strong>Library</strong> : React、Bootstrap、MUI、Tailwind CSS
            </li>
            <li className='mb-3'>
              <strong>DB</strong> : MySQL
            </li>
            <li className='mb-3'>
              <strong>ORM</strong> : TypeORM、Gin
            </li>
            <li className='mb-3'>
              <strong>AWS</strong> : ECS、Fargate、ElasticCache、
            </li>
            <li className='mb-3'>
              <strong>Tool</strong> : Gitlab、Figma、Miro、Trello、Notion,Docker
            </li>
          </ul>
            ...
            <li>
              ...
              <div className='timeline-content'>
                ...
                <p className='mt-3 pl-6'>
                  現在は主にサーバレスアーキテクチャを採用したWebアプリケーションのバックエンド開発をAWS
                  CDKを用いて行っています。
                </p>
                <p className='mt-3 pl-6'>
                  社内の新規事業コンテストなどにも参加をし、積極的に自らの管轄外での作業も行なっています。
                </p>
              </div>
            </li>
            <li>
              ...
              <div className='timeline-content'>
                ...
                <p className='mt-3 pl-6'>
                  MineCraft,Robloxを用いたプログラミング教室の運営に携わりました。
                </p>
                <p className='mt-3 pl-6'>
                  大人と子供との教え方の差にギャップを受けながらも、デジタルネイティブの受講生たちにかなり刺激を受けることができ、とても良い経験ができました。
                </p>
              </div>
            </li>
            <li>
              ...
              <div className='timeline-content'>
                ...
                <p className='mt-3 pl-6'>
                  HTML,CSS,Ruby,Rails,Git,AWSの教育、PF作成などにメンターとして携わっています。
                </p>
                <p className='mt-3 pl-6'>
                  在籍は二年になり、2023/10/1付で、四段階あるメンターランクの一番上に位置するメンターランクである「
                  <strong>JE</strong>」に到達しました。
                </p>
              </div>
            </li>
            <li>
              ...
              <div className='timeline-content'>
                ...
                <p className='mt-3 pl-6'>
                  専門学校で学んだこと以外の内容を重点的に勉強するので、両立に苦労しました。
                </p>
              </div>
            </li>
            <li>
              ...
              <div className='timeline-content'>
                ...
                <p className='mt-3 pl-6'>
                  学年の垣根を越えチーム開発を行なったり、プログラミングコンテストに参加したりしました。
                </p>
                <p className='mt-3 pl-6'>
                  資格取得にも力を入れ、応用情報技術者試験に合格しました。
                </p>
              </div>
            </li>
          </ul>
